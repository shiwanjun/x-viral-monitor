  ...
  async function runXAction(action) {
    ...
    for (const postId of ids) {
      try {
        ...
        const response = await window.__xvmNet.originalFetch(url.href, { method: 'POST', credentials: 'include', headers: liveHeaders(template, { 'content-type': 'application/json' }), body });
