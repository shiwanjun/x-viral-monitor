# Privacy Policy — X-Tools

**Last updated:** August 2026

## Summary
X-Tools does not sell data or use analytics, telemetry, or tracking pixels. Timeline analysis and caches stay in your browser. Network requests are limited to X, services needed for extension operation, and an AI provider only when you configure and use one.
...
- **Optional AI providers**: If you select an OpenAI-compatible provider and request a reply draft, the prompt and relevant tweet text are sent directly from your browser to that provider under its privacy policy. X-Tools does not proxy or retain that content.
- **Operational services**: The extension can download filter-rule updates from GitHub and contact the X-Tools license service for Pro activation and validation. These requests do not include tweet or browsing content.
...
- Does not send bookmark caches, browsing history, or X credentials to X-Tools servers
...
For questions about this privacy policy or deletion requests, email shiwanjun23@gmail.com or contact https://x.com/jieyi_ai. GitHub issues remain available for bug reports and feature requests.
